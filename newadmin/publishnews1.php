        ...
        <div id="main">
            ...
            <article class="post">
                ...
                <div class="container">
                    ...
                    <?php
                    // Content validation 
                    // $post_titleErr =  $post_tagErr =  $post_contentErr = "";
                    ...
                    //       if (!preg_grep("/[a-zA-Z 0-9]\s{15,120}/",  $post_title)) {
                    //             $post_titleErr = "Type Error Message";
                    //         }
                    //     }

                    //     if (empty($_POST["tags"])) {
                    //          $post_tagErr = "Tags is required";
                    //     } else {
                    //            $post_tag = test_input($_POST["tags"]);

                    //         if (!preg_grep("//",    $post_tag)) {
                    //                $post_tagErr = "Type Error Message";
                    //         }
                    //     }
                    //     if (empty($_POST["content"])) {
                    //         $post_contentErr = " Content is required";
                    //     } else {
                    //         $post_content = test_input($_POST["content"]);

                    //         if (!preg_grep("//",$post_content)) {
                    //             $post_contentErr = "Type Error Message";
                    //         }
                    //     }
                    // }
                ...
                window.location.href='posts.php';</script>";
                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="post_image">Post Image<font color='brown'> (Allowed image size: 1024 KB) </font> </label>
